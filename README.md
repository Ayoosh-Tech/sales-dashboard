...
- `SOP`: _Seperation of concerns_. Data, UI and styling must be kept apart. Components hold UI, hooks holds special functions etc  
...
NB: Whatever component you create no matter how complx or small it is, must always point back or be imported (in a way) to or inside the app.jsx for it to show on the page